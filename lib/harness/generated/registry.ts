...
export const PROMPT_HASHES = {
  "content-structuring": "96cd45c8e67f",
  "enrichment-structure": "af4acb07467e",
  "fact-check": "4d91db63500e",
  "grounded-place-search": "ebc7e62834b1",
  "intro-content-fill": "e72dce05939b",
  "itinerary-decomposition": "f5b0905b7f37",
...
export const USER_PROMPTS = {
  ...
  "enrichment-structure": {
    "default": "위 검색 텍스트를 장소별로 구조화하라. 각 장소의 요약에는 근거가 된 출처 번호를 달고, 근거가 없는 장소는 빼라.",
  },
  "fact-check": {
  ...
  "grounded-place-search": {
    "default": "위 장소들 각각을 웹에서 검색해, 찾은 실제 정보·특징·평판을 장소별로 정리하라. 못 찾은 장소는 그렇게 표시하라.",
  },
  "intro-content-fill": {
